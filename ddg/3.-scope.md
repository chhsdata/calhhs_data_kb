...
[Electronically collected personal information](#user-content-fn-4)[^4]:
...
#### Figure 2: Relationship Types of Reporting Variables

<figure><img src="../.gitbook/assets/Picture1.png" alt="This image is a venn diagram with three circles. Top circle is health and human services untilation data, bottom right is personal characteristics, boom left is providers data. When the personal characteristics overlap with either provider or utilization, or both, it&#x27;s considered PI/PHI. When provider overlaps with utilization data, it&#x27;s provider performance data."><figcaption><p>Figure 2: Relationship Types of Reporting Variables</p></figcaption></figure>

[^1]: Personal Information is defined by California Civil Code section 1798.3 and Government Code section 11015.5.
...
[^3]: California Civil Code 1798.3 (a)

[^4]: California Government Code 11015.5 (d) (1)CA

[^5]: Introduction to Statistical Disclosure Control, Templ et al. 2014

[^6]: U.S. Department of Commerce, National Institute of Standards and Technology, “De-Identifying Government Datasets: Techniques and Governance”, [https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-188.pdf](https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-188.pdf)
